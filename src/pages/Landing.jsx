      ...
      <div className="tip-suggestion-container">
        ...
        <div className="grid-container">
          <div className="row" id="row-one">
            <div className="square" id="00">
              W
            </div>
            <div className="square correct-letter" id="01">
              O
            </div>
            <div className="square correct-place" id="02">
              R
            </div>
            <div className="square" id="03">
              D
            </div>
            <div className="square wrong-letter" id="04">
              L
            </div>
          </div>

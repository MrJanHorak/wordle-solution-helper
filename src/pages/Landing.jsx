    ...
    <div className="solver-container">
      ...
      <div className="tip-suggestion-container">
        ...
        <div className="grid-container">
          <div className="row" id="row-one" onClick={activeRow===0 ? handleClick : undefined}>
          ...
          <div className="row" id="row-two" onClick={activeRow===1 ? handleClick : undefined}>
          ...
          <div className="row" id="row-three" onClick={activeRow===2 ? handleClick : undefined}>
          ...
          <div className="row" id="row-four" onClick={activeRow===3 ? handleClick : undefined}>
          ...
          <div className="row" id="row-five" onClick={activeRow===4 ? handleClick : undefined}>
          ...
          <div className="row" id="row-six" onClick={activeRow===5 ? handleClick : undefined}>
